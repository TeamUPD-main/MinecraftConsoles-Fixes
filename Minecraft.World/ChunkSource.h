...
#define LEVEL_WIDTH_CLASSIC 54 // Classic World Size
#define LEVEL_WIDTH_SMALL 64 // Small World Size
#define LEVEL_WIDTH_MEDIUM (3*64) // Medium World Size
#define LEVEL_WIDTH_LARGE (5*64) // Large World Size
